...
if __name__ == '__main__':
    ...
    if args['algorithm'] == 'ils':
        assignments, objective_value, steps, values = iterated_local_search.run_iterated_local_search(
            flows=flows,
            distances=distances,
        ...
        assignments, objective_value, steps, values = tabu_search.run_tabu_search(
            flows=flows,
            distances=distances,
        ...
        assignments, objective_value, steps, values = genetic_algorithm.run_genetic_algorithm(
            flows=flows,
            distances=distances,
    ...
    #     y='Value'
    # )
    # chart.save('./pic/chart.html', scale_factor=2.0)
    

    from utils.visual import drawPlot
    drawPlot(args['algorithm'] + '_' + '{0}'.format(args['genetic_selection_algorithm']) + '_' + args['filename'],steps, values)  
